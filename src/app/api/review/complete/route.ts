...
export async function POST(req: NextRequest) {
  try {
    ...
    const propertyToUpdate =
      reviewType === "next-day" ? "Reviewed Next Day" : "Reviewed Week Later";
          ...
          rich_text: [
            {
              ...
              text: {
                content:
                  edits || `Marked as reviewed on ${new Date().toDateString()}`,
              },
            },
          ],
        },
    ...
    console.log(
      `✅ Marked ${reviewType} review as complete for page ${pageId}`,
    );
